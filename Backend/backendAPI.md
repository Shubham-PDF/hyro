...
### 16. Get My Applications (Applicant)
**Endpoint:** `GET /applications/my-applications/`

**Description:** Get all job applications submitted by the authenticated applicant
  ...
  "applications": [
    {
      ...
      "company_name": "Tech Company Inc",
      "location": "San Francisco, CA",
      "resume_url": "https://cloudinary.example.com/resumes/user_1/job_id/resume.pdf",
      "match_score": 0.92,
      "applied_at": "2025-12-11T09:30:00Z"
    },
    {
      ...
      "resume_url": "https://cloudinary.example.com/resumes/user_1/job_id2/resume.pdf",
      "match_score": 0.78,
      "applied_at": "2025-12-10T14:20:00Z"
    }
  ]
...
### 17. Get Recruiter Dashboard Summary
**Endpoint:** `GET /dashboard/recruiter/summary/`

**Description:** Get summary statistics for recruiter's posted jobs and applications
...
**Response Parameters:**
- `total_jobs`: Total number of jobs posted by recruiter
- `total_applicants`: Total number of applicants across all jobs
- `jobs`: Array of job objects with statistics
  - `job_id`: Job ID
  - `title`: Job title
  - `applicant_count`: Number of applicants for this job
  - `top_match_score`: Highest match score for this job
...
### 18. Get Applicant Dashboard
**Endpoint:** `GET /dashboard/applicant/applications/`

**Description:** Get application history and statistics for applicant
...
**Response Parameters:**
- Array of application history objects:
  - `job_id`: Job ID
  - `title`: Job title
  - `applied_at`: Application submission timestamp
  - `resume_url`: URL to uploaded resume
...
|---------|------|---------|
| v1.1 | 2025-12-13 | Added Dashboard endpoints (Recruiter Summary, Applicant Applications) and documented Get My Applications endpoint |
