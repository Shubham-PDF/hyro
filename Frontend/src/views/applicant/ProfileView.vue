...
onMounted(async () => {
  ...
  if (user) {
    ...
    // Skills can arrive as an array or a comma-separated string; normalize safely
    ...
    <div class="bg-white rounded-[2rem] border border-slate-200 shadow-lg overflow-hidden">
      ...
      <div class="pt-20 px-8 pb-12">
        <form @submit.prevent="handleSave" class="space-y-10">
          ...
          <!-- SKILLS -->
          <div>
            <label class="font-semibold text-slate-700 text-sm mb-2 block">Skills</label>
            <div class="relative">
              <FileText class="absolute left-4 top-3.5 w-5 h-5 text-slate-400" />
              <input
                v-model="profile.skills"
                type="text"
                class="w-full pl-12 pr-4 py-3 border border-slate-200 rounded-xl bg-white focus:ring-2 outline-none transition-all"
                placeholder="Python, React, SQL, UI/UX..."
              />
            </div>
            <p class="text-xs text-slate-400 mt-1 ml-1">Separate skills with commas.</p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- LinkedIn -->
            <div>
              <label class="input-label font-semibold text-slate-700 text-sm mb-2 block"
                >LinkedIn</label
              >
              <div class="relative">
                <Linkedin class="absolute left-4 top-3.5 w-5 h-5 text-slate-400" />
                <input
            ...
            <div>
              ...
              >
              <div class="relative">
                <Github class="absolute left-4 top-3.5 w-5 h-5 text-slate-400" />
                <input
            ...
            <div>
              ...
              >
              <div class="relative">
                <Globe class="absolute left-4 top-3.5 w-5 h-5 text-slate-400" />
                <input
